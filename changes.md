Without deep understanding about the Play framework, I ported it to the TAkka version within less than 7 hours.  Following are changes I made to the Play source code.
